...
<style id='gt-style'></style>
		<link rel="stylesheet" href="pcss/imsearch.css?2025-1-7-0-639072978908027621" media="screen,print" />
...
Programma di Linguaggi plastici per le arti visive, triennio e biennio		</a>
	...
	</li><li class="imMnMnMiddle imPage" data-link-paths="|/programma-di-linguaggi-plastici-e-attivita-manipolative,-biennio.html">
<div class="label-wrapper">
<div class="label-inner-wrapper">
...
Didattica online		</a>
	...
	</li><li class="imMnMnMiddle imPage" data-link-paths=",/il-laboratorio-del-corso-di-linguaggi-plastici-per-le-arti-visive.html">
<div class="label-wrapper">
<div class="label-inner-wrapper">
...
$(function () {$('#imHeader_imMenuObject_02_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).show(); }, 250);    }).on('mouseleave', function () {        timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).hide(); }, 250);    });});});
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imHeader_imTextObject_07_tab0" style="opacity: 1; " role="tabpanel" tabindex="0">
		<div class="text-inner">
			<blockquote><div><span class="fs9lh1-5 ff1">DIPARTIMENTO DI ARTI VISIVE<br></span></div><div><span class="fs9lh1-5 ff1">SCUOLA DI DECORAZIONE</span></div><div><b><span class="fs9lh1-5 ff1">Settore artistico-disciplinare (SAD), Linguaggi plastici per le arti visive</span></b></div><div><span class="fs9lh1-5 ff1">Profili disciplinari: Linguaggi plastici per le arti visive, CFA 8 - Tecniche plastiche contemporanee, CFA 8</span></div><div><span class="fs9lh1-5 ff1">Triennio e Biennio specialistico</span></div><div><span class="fs9lh1-5 ff1">Codice SAD: AFAM112</span></div><div><span class="fs9lh1-5 ff1"><br></span></div><div><span class="fs9lh1-5 ff1">DIPARTIMENTO DI COMUNICAZIONE E DIDATTICA DELL'ARTE<br></span></div><div><span class="fs9lh1-5 ff1">SCUOLA DI DIDATTICA DELL'ARTE</span></div><div><span class="fs9lh1-5 ff1"><b>EDUCAZIONE, MEDIAZIONE E COMUNICAZIONE DELL'ARTE</b><br></span></div><div><span class="fs9lh1-5 ff1">Profilo disciplinare: Linguaggi plastici e attività manipolative, CFA 6</span></div><div><span class="fs9lh1-5 ff1">Codice SAD: ABST60</span></div><div><span class="fs9lh1-5 ff1">Professore Ordinario: Danilo Ciaramaglia &nbsp;&nbsp;</span><br></div></blockquote>
		</div>
	</div>
...
$(function () {$('#imStickyBar_imMenuObject_01_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_01_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_01_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_23_tab0" style="opacity: 1; " role="tabpanel" tabindex="0">
		<div class="text-inner">
			<div><span class="fs9lh1-5 ff1">DIPARTIMENTO DI ARTI VISIVE<br></span></div><div><span class="fs9lh1-5 ff1">SCUOLA DI DECORAZIONE</span></div><div><b><span class="fs9lh1-5 ff1">SAD: Linguaggi plastici per le arti visive</span></b></div><div><span class="fs9lh1-5 ff1">Profili disciplinari: Linguaggi plastici per le arti visive, CFA 8</span></div><div><span class="fs9lh1-5 ff1">Tecniche plastiche contemporanee, CFA 8</span></div><div><span class="fs9lh1-5 ff1">Triennio e Biennio specialistico</span></div><div><span class="fs9lh1-5 ff1">Codice SAD: AFAM112</span></div><div><span class="fs9lh1-5 ff1"><br></span></div><div><span class="fs9lh1-5 ff1">DIPARTIMENTO DI COMUNICAZIONE E DIDATTICA DELL'ARTE<br></span></div><div><span class="fs9lh1-5 ff1">SCUOLA DI DIDATTICA DELL'ARTE</span></div><div><span class="fs9lh1-5 ff1"><b>EDUCAZIONE, MEDIAZIONE E COMUNICAZIONE DELL'ARTE</b><br></span></div><div><span class="fs9lh1-5 ff1">Profilo disciplinare: Linguaggi plastici e attività manipolative, CFA 6</span></div><div><span class="fs9lh1-5 ff1">Codice SAD: ABST60</span></div><div><span class="fs9lh1-5 ff1"><br></span></div><div><span class="fs9lh1-5 ff1">Professore Ordinario: Danilo Ciaramaglia &nbsp;&nbsp;&nbsp;&nbsp;</span></div>
		</div>
	</div>
 ...
 x5engine.boot.push(function(){
	...
	<div data-index="0"  class="text-tab-content grid-prop current-tab "  id="imFooter_imTextObject_39_tab0" style="opacity: 1; " role="tabpanel" tabindex="0">
		<div class="text-inner">
			<div><span class="fs8lh1-5 ff1">DIPARTIMENTO DI ARTI VISIVE<br></span></div><div><span class="fs8lh1-5 ff1">SCUOLA DI DECORAZIONE</span></div><div><b><span class="fs8lh1-5 ff1">SAD: Linguaggi plastici per le arti visive</span></b></div><div><span class="fs8lh1-5 ff1">Profili disciplinari: Linguaggi plastici per le arti visive, CFA 8</span></div><div><span class="fs8lh1-5 ff1">Tecniche plastiche contemporanee, CFA 8</span></div><div><span class="fs8lh1-5 ff1">Triennio e Biennio specialistico</span></div><div><span class="fs8lh1-5 ff1">Codice SAD: AFAM112</span></div><div><span class="fs8lh1-5 ff1"><br></span></div><div><span class="fs8lh1-5 ff1">DIPARTIMENTO DI COMUNICAZIONE E DIDATTICA DELL'ARTE<br></span></div><div><span class="fs8lh1-5 ff1">SCUOLA DI DIDATTICA DELL'ARTE</span></div><div><span class="fs8lh1-5 ff1"><b>EDUCAZIONE, MEDIAZIONE E COMUNICAZIONE DELL'ARTE</b><br></span></div><div><span class="fs8lh1-5 ff1">Profilo disciplinare: Linguaggi plastici e attività manipolative, CFA 6</span></div><div><span class="fs8lh1-5 ff1">Codice SAD: ABST60</span></div><div><span class="fs8lh1-5 ff1"><br></span></div><div><span class="fs8lh1-5 ff1">Professore Ordinario: Danilo Ciaramaglia &nbsp;&nbsp;&nbsp;&nbsp;</span></div>
		</div>
	</div>
